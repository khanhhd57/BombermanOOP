...
public class Sprite {
	...
	//Doll
	public static Sprite doll_left1 = new Sprite(16, 8, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite doll_left2 = new Sprite(16, 8, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite doll_left3 = new Sprite(16, 8, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite doll_right1 = new Sprite(16, 9, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite doll_right2 = new Sprite(16, 9, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite doll_right3 = new Sprite(16, 9, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite doll_dead = new Sprite(16, 8, 8, SpriteSheet.tiles, 16, 16);
	...
	//Kondoria
	public static Sprite kondoria_left1 = new Sprite(16, 6, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite kondoria_left2 = new Sprite(16, 6, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite kondoria_left3 = new Sprite(16, 6, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite kondoria_right1 = new Sprite(16, 7, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite kondoria_right2 = new Sprite(16, 7, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite kondoria_right3 = new Sprite(16, 7, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite kondoria_dead = new Sprite(16, 6, 8, SpriteSheet.tiles, 16, 16);
